...
export const ExpandedProjectView = ({
  ...
  const [gerarProjetoFields, setGerarProjetoFields] = useState({
    ...
    caixa_medicao_tipo: (project as any).caixa_medicao_tipo || '',
    padrao_entrada: (project as any).padrao_entrada || '',
    fases_instalacao: (project as any).fases_instalacao || '',
    cabos_secao: (project as any).cabos_secao || '',
    ...
    // Formulário GD Energisa (Folhas 1, 4 e 5)
    numero_endereco_cliente: (project as any).numero_endereco_cliente || '',
    bairro_cliente: (project as any).bairro_cliente || '',
    numero_fases: (project as any).numero_fases || '',
    cabos_por_fase: (project as any).cabos_por_fase || '',
    dps_ca_ka: (project as any).dps_ca_ka || '',
    dps_cc_ka: (project as any).dps_cc_ka || '',
    ...
    potencia_trafo_exclusivo: (project as any).potencia_trafo_exclusivo || '',

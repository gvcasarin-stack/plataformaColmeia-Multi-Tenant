    ...
    <Document>
      <Page size="A4" style={s.page}>
        ...
        <View style={s.tbl}>
          ...
          <View style={s.row}>
            <View style={[s.lr, { width: '20%' }]}><Text>Nome Completo</Text></View>
            <View style={[s.d, { width: '35%' }]}><Text>{v('responsavel_nome', pd)}</Text></View>
            <View style={[s.lr, { width: '25%' }]}><Text>Titulo Profissional</Text></View>
            <View style={[s.d, { width: '8%' }]}><Text>{v('responsavel_profissao', pd)}</Text></View>
            <View style={[s.lr, { width: '6%' }]}><Text>Registro</Text></View>
            <View style={[s.d, { width: '6%' }]}><Text>Nº {v('responsavel_registro', pd)}</Text></View>
          </View>
          <View style={s.row}>
        ...
        <View style={s.tbl}>
          ...
          <View style={s.row}>
            <View style={[s.d, { width: '92%', fontSize: 6 }]}><Text>Solicito dispensa da análise de inversão de fluxo por enquadramento no art. 73-A da REN 1000, na seguinte regra:</Text></View>
            <View style={[s.d, { width: '8%' }]}><Text></Text></View>
          </View>
          {([
        ...
        <View style={s.tbl}>
          ...
          <View style={s.row}>
            <View style={[s.d, { width: '35%', fontSize: 6 }]}>
              <Text>Local: {v('cidade', pd)}-{v('estado', pd)}</Text>
            </View>
            <View style={[s.d, { width: '35%', fontSize: 6 }]}>
              <Text>Data: {v('data', pd)}</Text>
            </View>
            <View style={[s.d, { width: '30%', fontSize: 6, textAlign: 'center' }]}>
              <Text style={{ borderTopWidth: 0.5, borderColor: BC, paddingTop: 14, marginTop: 4 }}>Assinatura do Responsável</Text>
            </View>
          </View>
        </View>
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.tbl}>
          <View style={s.row}>
            <View style={[s.ch, { width: '5%' }]}><Text>Item</Text></View>
            <View style={[s.ch, { width: '16%' }]}><Text>Potência do Módulo (W)</Text></View>
            <View style={[s.ch, { width: '12%' }]}><Text>Quantidade</Text></View>
            <View style={[s.ch, { width: '18%' }]}><Text>Potência de Pico (kWp)</Text></View>
            <View style={[s.ch, { width: '16%' }]}><Text>Área do arranjo (m²)</Text></View>
            <View style={[s.ch, { width: '20%' }]}><Text>Fabricante(s) dos Módulos</Text></View>
            <View style={[s.ch, { width: '13%' }]}><Text>Modelo</Text></View>
          </View>
          <View style={s.row}>
          ...
          {Array.from({ length: 9 }).map((_, i) => (
            <View key={i} style={s.row}>
              <View style={[s.d, { width: '5%', textAlign: 'center', color: '#999', fontSize: 6 }]}><Text>{i + 2}</Text></View>
              <View style={[s.d, { width: '16%' }]}><Text></Text></View>
              <View style={[s.d, { width: '12%' }]}><Text></Text></View>
              <View style={[s.d, { width: '18%' }]}><Text></Text></View>
              <View style={[s.d, { width: '16%' }]}><Text></Text></View>
              <View style={[s.d, { width: '20%' }]}><Text></Text></View>
              <View style={[s.d, { width: '13%' }]}><Text></Text></View>
            </View>
          ))}
          <View style={s.row}>
            <View style={[s.tot, { width: '5%' }]}><Text>TOTAL</Text></View>
            <View style={[s.d, { width: '16%' }]}><Text></Text></View>
        ...
        <View style={s.tbl}>
          <View style={s.row}>
            <View style={[s.ch, { width: '4%' }]}><Text>Item</Text></View>
            <View style={[s.ch, { width: '14%' }]}><Text>Fabricante*</Text></View>
            <View style={[s.ch, { width: '16%' }]}><Text>Modelo*</Text></View>
            <View style={[s.ch, { width: '12%' }]}><Text>Potência Nominal (kW)</Text></View>
            <View style={[s.ch, { width: '13%' }]}><Text>Faixa de tensão (V)</Text></View>
            <View style={[s.ch, { width: '10%' }]}><Text>Corrente Nominal (A)</Text></View>
            <View style={[s.ch, { width: '11%' }]}><Text>Fator de Potência</Text></View>
            <View style={[s.ch, { width: '10%' }]}><Text>Rendimento (%)</Text></View>
            <View style={[s.ch, { width: '10%' }]}><Text>DHT Corrente (%)</Text></View>
          </View>
          ...
          {Array.from({ length: Math.max(0, 30 - inversoresQtd) }).map((_, i) => (
            <View key={i} style={s.row}>
              <View style={[s.d, { width: '4%', textAlign: 'center', color: '#999', fontSize: 6 }]}><Text>{inversoresQtd + i + 1}</Text></View>
              <View style={[s.d, { width: '14%' }]}><Text></Text></View>
              <View style={[s.d, { width: '16%' }]}><Text></Text></View>
              <View style={[s.d, { width: '12%' }]}><Text></Text></View>
              <View style={[s.d, { width: '13%' }]}><Text></Text></View>
              <View style={[s.d, { width: '10%' }]}><Text></Text></View>
        ...
        <View style={s.tbl}>
          <View style={s.row}>
            <View style={[s.ch, { width: '4%' }]}><Text>Item</Text></View>
            <View style={[s.ch, { width: '16%' }]}><Text>Fabricante/Modelo</Text></View>
            <View style={[s.ch, { width: '9%' }]}><Text>Eixo do rotor (horiz./vert.)*</Text></View>
            <View style={[s.ch, { width: '8%' }]}><Text>Altura Máxima da Pá (m)*</Text></View>
            <View style={[s.ch, { width: '8%' }]}><Text>Diâmetro do rotor (m)</Text></View>
            <View style={[s.ch, { width: '9%' }]}><Text>Controle de Potência</Text></View>
            <View style={[s.ch, { width: '8%' }]}><Text>Vel. rotação nom./Sobrevel. máx. (rpm)</Text></View>
            <View style={[s.ch, { width: '9%' }]}><Text>Vel. vento Entrada (m/s)</Text></View>
            <View style={[s.ch, { width: '9%' }]}><Text>Vel. vento Saída (m/s)</Text></View>
            <View style={[s.ch, { width: '9%' }]}><Text>Pot. Entrada (kW)</Text></View>
            <View style={[s.ch, { width: '9%' }]}><Text>Pot. Saída (kW)</Text></View>
            <View style={[s.ch, { width: '6%' }]}><Text>MD²/4 (kg.m²)</Text></View>
            <View style={[s.ch, { width: '6%' }]}><Text>Cert.</Text></View>
          </View>
          {Array.from({ length: 10 }).map((_, i) => (
            <View key={i} style={s.row}>
              <View style={[s.d, { width: '4%', textAlign: 'center', fontSize: 6 }]}><Text>{i + 1}</Text></View>
              {([16, 9, 8, 8, 9, 8, 9, 9, 9, 9, 6, 6] as number[]).map((w, j) => (
                <View key={j} style={[s.d, { width: `${w}%` }]}><Text></Text></View>
              ))}
            </View>
          ))}
          <View style={s.row}>
        ...
        <View style={s.tbl}>
          <View style={s.row}>
            ...
            {(['Rio', 'Bacia / SubBacia', 'Tipo turbina', 'Fabricante Turbina', 'Potência Turbina (kVA)', 'Fabricante Gerador', 'Potência Gerador (kVA)', 'Fator de Potência', 'Potência Gerador (kW)'] as string[]).map(h => (
              <View key={h} style={[s.ch, { flex: 1 }]}><Text>{h}</Text></View>
            ))}
          </View>
          {[1, 2, 3].map(i => (
            <View key={i} style={s.row}>
              <View style={[s.d, { width: '4%', textAlign: 'center', fontSize: 6 }]}><Text>{i}</Text></View>
              {Array.from({ length: 9 }).map((_, j) => <View key={j} style={[s.d, { flex: 1 }]}><Text></Text></View>)}
            </View>
          ))}
          <View style={s.row}>
            <View style={[s.tot, { width: '4%' }]}><Text>TOTAL</Text></View>
        ...
        <View style={s.tbl}>
          <View style={s.row}>
            <View style={[s.ch, { width: '20%' }]}><Text>Informação</Text></View>
            <View style={[s.ch, { width: '20%' }]}><Text>Especificação</Text></View>
            <View style={[s.ch, { width: '20%' }]}><Text>Unidade</Text></View>
            <View style={[s.ch, { width: '20%' }]}><Text>Periodicidade</Text></View>
            <View style={[s.ch, { width: '20%' }]}><Text>Observação</Text></View>
          </View>

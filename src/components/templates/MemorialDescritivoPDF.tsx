                ...
                {units.map(({ n, secaoFase, secaoNeutro, secaoTerra, cap, ft, fa }) => {
                  ...
                  return (
                    <View key={n}>
                      ...
                      <Li>{`Seção Transversal do(s) Condutor(es) Fase [mm²]: ${secaoFase || v('cabo_ca_secao_fase_mm2', projectData)}`}</Li>
                      <Li>{`Seção Transversal do Condutor Neutro [mm²]: ${secaoNeutro || v('cabo_ca_secao_neutro_mm2', projectData)}`}</Li>
                      <Li>{`Seção Transversal do Condutor Terra [mm²]: ${secaoTerra || v('cabo_ca_secao_terra_mm2', projectData)}`}</Li>

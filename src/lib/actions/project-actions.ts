...
export async function getProjectAction(projectId: string): Promise<{
  ...
  try {
    ...
    const project: Project = {
      ...
      cpfl_tipo_poste_padrao: (data as any).cpfl_tipo_poste_padrao || undefined,
      caixa_medicao_tipo: (data as any).caixa_medicao_tipo || undefined,
      padrao_entrada: (data as any).padrao_entrada || undefined,
      fases_instalacao: (data as any).fases_instalacao || undefined,
      cabos_secao: (data as any).cabos_secao || undefined,
      ...
      numero_fases: data.numero_fases || undefined,
      cabos_por_fase: data.cabos_por_fase || undefined,
      dps_ca_ka: data.dps_ca_ka || undefined,
      dps_cc_ka: data.dps_cc_ka || undefined,
      ...
      potencia_trafo_exclusivo: data.potencia_trafo_exclusivo || undefined,
      cabo_quadro_ca_secao_mm2: data.cabo_quadro_ca_secao_mm2 || undefined,
      cabo_quadro_ca_capacidade_corrente_a: data.cabo_quadro_ca_capacidade_corrente_a || undefined,
      cabo_quadro_ca_fator_temperatura: data.cabo_quadro_ca_fator_temperatura || undefined,
      cabo_quadro_ca_fator_agrupamento: data.cabo_quadro_ca_fator_agrupamento || undefined,
      ...
      cabo_cc_metodo_instalacao_profundidade: data.cabo_cc_metodo_instalacao_profundidade || undefined,
